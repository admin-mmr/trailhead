...
Routes:
  ...
  POST /api/members/family/upgrade-and-add  — upgrade Individual→Family, generate FamilyID, add second member
"""
...
# ─────────────────────────────────────────────────────────────────
# Route module imports — register composite family operations
# (upgrade-and-add) on members_family_bp. Must come AFTER the blueprint
# and generate_family_id are defined above, since api_members_family_ops
# imports them from this module. The import itself is the side-effect
# that registers the routes. Mirrors the api_payments split.
# ─────────────────────────────────────────────────────────────────
from api_members_family_ops import *  # noqa: E402, F401, F403
