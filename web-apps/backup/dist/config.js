...
const DEFAULT_PAYMENT_EVENTS_ROWS = [
...
function getConfigValue(key) {
    var _a;
    return (_a = getConfigMap()[key]) !== null && _a !== void 0 ? _a : '';
}
...
globalThis.getSheet = getSheet;
globalThis.getConfigMap = getConfigMap;
globalThis.getConfigValue = getConfigValue;
globalThis.setConfigValue = setConfigValue;
// Export config constants so cross-module calls can resolve them in the test environment
globalThis.SHEET_NAMES = SHEET_NAMES;
globalThis.GMAIL_SHEETS = GMAIL_SHEETS;
globalThis.MM_COL = MM_COL;
globalThis.ML_COL = ML_COL;
globalThis.ML_MM_OFFSET = ML_MM_OFFSET;
globalThis.WE_COL = WE_COL;
globalThis.PH_COL = PH_COL;
globalThis.OTP_COL = OTP_COL;
globalThis.LOG_COL = LOG_COL;
globalThis.FG_COL = FG_COL;
globalThis.CFG_COL = CFG_COL;
globalThis.PCE_COL = PCE_COL;
globalThis.MEMBERSHIP_SPREADSHEET_ID = MEMBERSHIP_SPREADSHEET_ID;
globalThis.GMAIL_SPREADSHEET_ID = GMAIL_SPREADSHEET_ID;
