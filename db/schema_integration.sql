...
CREATE PROCEDURE sp_cancel_payment (IN p_payment_id VARCHAR(50))
BEGIN
...
CREATE PROCEDURE sp_clear_transaction (IN p_tx_number VARCHAR(100), IN p_dry_run TINYINT(1))
BEGIN
...
CREATE PROCEDURE sp_revert_admin_override (IN p_OverrideID INT)
proc_body: BEGIN
