-- Generated by /api/export-schema-ddl — 2026-05-27 01:46 UTC
...
CREATE TABLE IF NOT EXISTS `admin_member_overrides` (
  ...
  `ActionType` enum('STATUS_CHANGE','EXPIRATION_OVERRIDE','LIFETIME_SET','INACTIVE_SET','MARK_ACTIVE','REVERT') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `member_duplicate_dismissals` (
  ...
  `dup_type` enum('name','phone','wechat') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `member_log` (
  ...
  KEY `idx_member_log_member_time` (`MemberID`,`LoggingTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `nyrr_event_runners` (
  ...
  `match_method` enum('auto_name','auto_lastname','auto_firstlast','auto_partial_name','manual','not_member','unmatched','auto_fuzzy') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Match tier: auto_fuzzy = Tier-4 rapidfuzz hit awaiting confirmation',
  `confidence_score` tinyint DEFAULT NULL COMMENT 'Fuzzy match score 0-100 (Tier-4 only)',
...
) ENGINE=InnoDB AUTO_INCREMENT=947361 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `nyrr_event_series` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Human-readable series name, e.g. "Brooklyn Half"',
  `slug` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'URL-safe identifier, e.g. "brooklyn-half"',
  `distance_km` decimal(6,3) DEFAULT NULL COMMENT 'Canonical race distance in km (NULL = multi-distance)',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_series_slug` (`slug`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Race-distance series registry for Hall of Fame grouping';
...
CREATE TABLE IF NOT EXISTS `nyrr_events` (
  ...
  `mmr_finisher_count` int DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `series_id` int DEFAULT NULL,
  `load_mode` enum('full','mmr_only') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'full',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_load_mode` (`load_mode`),
  CONSTRAINT `fk_nyrr_events_series` FOREIGN KEY (`series_id`) REFERENCES `nyrr_event_series` (`id`) ON DELETE SET NULL
...
CREATE TABLE IF NOT EXISTS `nyrr_processing_log` (
  ...
  `teams_processed` int NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `races` (
  ...
  `recap_mdx` text COLLATE utf8mb4_unicode_ci,
...
) ENGINE=InnoDB AUTO_INCREMENT=260 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tracks sheets sync batches for resume capability and monitoring';
...
CREATE TABLE IF NOT EXISTS `team_records` (
  ...
  `athlete_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `member_id` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `race_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `race_date` date DEFAULT NULL,
  `race_location` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_verified` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_distance_gender` (`distance`,`gender`),
  KEY `member_id` (`member_id`),
  CONSTRAINT `team_records_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `members` (`MemberID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `training_plans` (
  ...
  `goal_distance` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duration_weeks` int DEFAULT NULL,
  `level` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `full_plan_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `weekly_runs` (
  ...
  `pace_group` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `distance_miles` decimal(4,1) DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `coach_id` int DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `coach_id` (`coach_id`),
  CONSTRAINT `weekly_runs_ibfk_1` FOREIGN KEY (`coach_id`) REFERENCES `coaches` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
