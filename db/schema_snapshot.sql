...
notification_log	InnoDB	utf8mb4_unicode_ci	Ledger of member-facing emails; dedupe_key makes scheduled jobs idempotent
nyrr_event_rsvps	InnoDB	utf8mb4_unicode_ci	Member RSVPs for NYRR events (P1L member portal calendar)
...
poll_ballot_choices	InnoDB	utf8mb4_unicode_ci	
poll_ballots	InnoDB	utf8mb4_unicode_ci	
poll_options	InnoDB	utf8mb4_unicode_ci	
polls	InnoDB	utf8mb4_unicode_ci	
...
stripe_events	InnoDB	utf8mb4_unicode_ci	
...
members	26	ShowRsvpPublicly	tinyint(1)	NO	1			Show this member by name on shared event RSVP rosters (0 = counted only)
notification_log	1	id	bigint	NO	NULL	auto_increment	PRI	
notification_log	2	MemberID	varchar(10)	YES	NULL		MUL	FK to members.MemberID; NULL for anonymous recipients
notification_log	3	email_type	varchar(50)	NO	NULL		MUL	Matches EMAIL_TYPES in lib/email/registry.ts
notification_log	4	stage	varchar(30)	YES	NULL			Reminder stage (T60/T30/T7/LAPSED_14/FINAL_45) where applicable
notification_log	5	dedupe_key	varchar(160)	YES	NULL		UNI	UNIQUE when set — prevents duplicate sends. NULL for retryable failures
notification_log	6	recipient	varchar(255)	NO	NULL			
notification_log	7	subject	varchar(255)	YES	NULL			
notification_log	8	status	enum('sent','failed','skipped')	NO	sent			
notification_log	9	error	text	YES	NULL			
notification_log	10	created_at	datetime	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED		
nyrr_event_rsvps	1	id	int	NO	NULL	auto_increment	PRI	
nyrr_event_rsvps	2	nyrr_event_id	int	NO	NULL		MUL	FK to nyrr_events.id
nyrr_event_rsvps	3	MemberID	varchar(10)	NO	NULL		MUL	FK to members.MemberID
nyrr_event_rsvps	4	intent	enum('running','volunteering','interested','not_going')	NO	NULL			What the member plans to do at this event
nyrr_event_rsvps	5	note	varchar(280)	YES	NULL			Optional member note, e.g. pace group or volunteer shift
nyrr_event_rsvps	6	created_at	datetime	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED		
nyrr_event_rsvps	7	updated_at	datetime	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED on update CURRENT_TIMESTAMP		
...
poll_ballot_choices	1	id	int	NO	NULL	auto_increment	PRI	
poll_ballot_choices	2	ballot_id	int	NO	NULL		MUL	
poll_ballot_choices	3	option_id	int	NO	NULL		MUL	
poll_ballot_choices	4	rank_pos	tinyint unsigned	NO	1			
poll_ballots	1	id	int	NO	NULL	auto_increment	PRI	
poll_ballots	2	poll_id	int	NO	NULL		MUL	
poll_ballots	3	MemberID	varchar(10)	YES	NULL		MUL	
poll_ballots	4	comment	varchar(1000)	YES	NULL			
poll_ballots	5	ip_hash	char(64)	YES	NULL			
poll_ballots	6	created_at	timestamp	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED		
poll_ballots	7	updated_at	timestamp	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED on update CURRENT_TIMESTAMP		
poll_options	1	id	int	NO	NULL	auto_increment	PRI	
poll_options	2	poll_id	int	NO	NULL		MUL	
poll_options	3	code	varchar(32)	NO	NULL			
poll_options	4	label_en	varchar(200)	NO	NULL			
poll_options	5	label_zh	varchar(200)	YES	NULL			
poll_options	6	tagline_en	varchar(400)	YES	NULL			
poll_options	7	tagline_zh	varchar(400)	YES	NULL			
poll_options	8	image_path	varchar(400)	YES	NULL			
poll_options	9	detail_path	varchar(400)	YES	NULL			
poll_options	10	sort_order	smallint	NO	0			
polls	1	id	int	NO	NULL	auto_increment	PRI	
polls	2	slug	varchar(64)	NO	NULL		UNI	
polls	3	title_en	varchar(200)	NO	NULL			
polls	4	title_zh	varchar(200)	YES	NULL			
polls	5	description_en	text	YES	NULL			
polls	6	description_zh	text	YES	NULL			
polls	7	mode	enum('single','top3')	NO	top3			
polls	8	status	enum('draft','open','closed')	NO	draft			
polls	9	results_visibility	enum('after_vote','public','admin')	NO	after_vote			
polls	10	voter_check	enum('member','open')	NO	member			
polls	11	opens_at	datetime	YES	NULL			
polls	12	closes_at	datetime	YES	NULL			
polls	13	created_at	timestamp	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED		
polls	14	updated_at	timestamp	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED on update CURRENT_TIMESTAMP		
...
stripe_events	1	event_id	varchar(100)	NO	NULL		PRI	
stripe_events	2	payment_intent_id	varchar(100)	YES	NULL			
stripe_events	3	status	varchar(30)	NO	processed			
stripe_events	4	payload_hash	varchar(64)	YES	NULL			
stripe_events	5	processed_at	datetime	NO	CURRENT_TIMESTAMP	DEFAULT_GENERATED		
stripe_events	6	livemode	tinyint(1)	NO	0			
...
submissions	4	MemberID	varchar(10)	YES	NULL		MUL	submitter MemberID from members table; NULL for anonymous donations
...
notification_log	idx_notification_member	1	1	MemberID	BTREE	YES
notification_log	idx_notification_type_created	1	1	email_type	BTREE	
notification_log	idx_notification_type_created	1	2	created_at	BTREE	
notification_log	PRIMARY	0	1	id	BTREE	
notification_log	uq_notification_dedupe	0	1	dedupe_key	BTREE	YES
nyrr_event_rsvps	idx_rsvp_member	1	1	MemberID	BTREE	
nyrr_event_rsvps	PRIMARY	0	1	id	BTREE	
nyrr_event_rsvps	uq_rsvp_event_member	0	1	nyrr_event_id	BTREE	
nyrr_event_rsvps	uq_rsvp_event_member	0	2	MemberID	BTREE	
...
poll_ballot_choices	idx_choice_option	1	1	option_id	BTREE	
poll_ballot_choices	PRIMARY	0	1	id	BTREE	
poll_ballot_choices	uq_choice_ballot_option	0	1	ballot_id	BTREE	
poll_ballot_choices	uq_choice_ballot_option	0	2	option_id	BTREE	
poll_ballot_choices	uq_choice_ballot_rank	0	1	ballot_id	BTREE	
poll_ballot_choices	uq_choice_ballot_rank	0	2	rank_pos	BTREE	
poll_ballots	fk_poll_ballots_member	1	1	MemberID	BTREE	YES
poll_ballots	idx_ballot_poll	1	1	poll_id	BTREE	
poll_ballots	PRIMARY	0	1	id	BTREE	
poll_ballots	uq_ballot_poll_member	0	1	poll_id	BTREE	
poll_ballots	uq_ballot_poll_member	0	2	MemberID	BTREE	YES
poll_options	idx_poll_option_sort	1	1	poll_id	BTREE	
poll_options	idx_poll_option_sort	1	2	sort_order	BTREE	
poll_options	PRIMARY	0	1	id	BTREE	
poll_options	uq_poll_option_code	0	1	poll_id	BTREE	
poll_options	uq_poll_option_code	0	2	code	BTREE	
polls	PRIMARY	0	1	id	BTREE	
polls	uq_polls_slug	0	1	slug	BTREE	
...
stripe_events	PRIMARY	0	1	event_id	BTREE	
submissions	fk_submission_member	1	1	MemberID	BTREE	YES
...
notification_log	MemberID	fk_notification_member	members	MemberID	NO ACTION	SET NULL
nyrr_event_rsvps	MemberID	fk_rsvp_member	members	MemberID	NO ACTION	CASCADE
nyrr_event_rsvps	nyrr_event_id	fk_rsvp_event	nyrr_events	id	NO ACTION	CASCADE
...
poll_ballot_choices	ballot_id	fk_choices_ballot	poll_ballots	id	NO ACTION	CASCADE
poll_ballot_choices	option_id	fk_choices_option	poll_options	id	NO ACTION	CASCADE
poll_ballots	MemberID	fk_poll_ballots_member	members	MemberID	NO ACTION	CASCADE
poll_ballots	poll_id	fk_poll_ballots_poll	polls	id	NO ACTION	CASCADE
poll_options	poll_id	fk_poll_options_poll	polls	id	NO ACTION	CASCADE
