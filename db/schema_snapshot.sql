...
CREATE TABLE `members` (
  `MemberID` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Status` enum('active','expired','inactive','pending','not active') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'active=paying; expired=may renew (send reminders); inactive=left (no reminders); pending=awaiting payment',
