...
-- Timestamp: 2026-04-03T23:08:50.948774 UTC
...
CREATE TABLE `members` (
  ...
  `last_login_unix` bigint DEFAULT '0' COMMENT 'Unix timestamp for last login',
  ...
  KEY `idx_members_last_login_unix` (`last_login_unix`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Columns: SubmissionID, SubmissionType, SubmittedAt, ExpirationTime, MemberID,
--          Email, PaymentIntent, Amount, PaymentMethod, PayerName, MemoField,
--          Last4Digits, FamilyMemberEmails, Status, MatchedMessageId,
--          MatchedTransactionNumber, AdminApprover, ApprovedAt, Notes,
--          PaymentDate, ScreenshotId, GDriveFilePath, OCRText, OCRProcessedAt,
--          CreatedAt, UpdatedAt, timestamp_unix, expires_at_unix, approval_date_unix
